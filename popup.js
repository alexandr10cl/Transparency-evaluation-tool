...
// Recupera tasks do Flask e gera dinamicamente o HTML
      ...
      tasks.forEach(task => {
        ...
        taskWrapper.innerHTML = `
          <div class="task" id="task${task.id}">
            <h1>Task ${task.id}</h1>
            <h2 id="task${task.id}_title">${task.description}</h2>
            <button id="finishTask${task.id}Button">Finish</button>
            <button class="couldntsolve" id="couldntSolveTask${task.id}Button">Couldn't solve it?</button>
          </div>
